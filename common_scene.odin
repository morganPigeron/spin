...
setup_common_scene :: proc(game_ctx: ^GameCtx) {
	...
	append(&game_ctx.enemies, create_enemy(game_ctx^, {700, f32(UNIT * 2)}, .BOY1))
	append(&game_ctx.enemies, create_enemy(game_ctx^, {780, f32(UNIT * 2)}, .GIRL1))
	append(&game_ctx.enemies, create_enemy(game_ctx^, {860, f32(UNIT * 2)}, .GIRL2))
